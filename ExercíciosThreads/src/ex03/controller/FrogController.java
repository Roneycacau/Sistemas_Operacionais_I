...
public class FrogController implements ActionListener {
	...
	public FrogController(Semaphore farol, JLabel lbFrog1,JLabel lbFrog2,JLabel lbFrog3,JLabel lbFrog4,JLabel lbFrog5,JButton btnIniciar, 
	...
	private void startButtom() {
		...
		Thread t1 = new ThreadFrog(farol, lbFrog1, btnIniciar,textArea, f1, lbFinish, textAreaFrog1);
		Thread t2 = new ThreadFrog(farol, lbFrog2, btnIniciar,textArea, f2, lbFinish, textAreaFrog2);
		Thread t3 = new ThreadFrog(farol, lbFrog3, btnIniciar,textArea, f3, lbFinish, textAreaFrog3);
		Thread t4 = new ThreadFrog(farol, lbFrog4, btnIniciar,textArea, f4, lbFinish, textAreaFrog4);
		Thread t5 = new ThreadFrog(farol, lbFrog5, btnIniciar,textArea, f5, lbFinish, textAreaFrog5);
